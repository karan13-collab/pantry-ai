...
const Register = () => {
  ...
  const onRegisterSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        err.response?.data?.msg || "Registration failed. Please check inputs."
      );
      setIsLoading(false);
    }
  };
      ...
      <div className="register-card">
        <div className="header-container">
          ...
          <p className="step-subtitle">
            {step === 1
              ? "Join the smart kitchen revolution."
          ...
          <form onSubmit={onRegisterSubmit}>
            <div className="section-group">
              ...
              <div className="form-grid-2">
                <button
                  type="button"
                  onClick={() =>
                    setFormData({ ...formData, householdAction: "create" })
                  }
                  className={`household-btn ${
                    formData.householdAction === "create" ? "active-create" : ""
                  }`}
                >
                ...
                <button
                  type="button"
                  onClick={() =>
                    setFormData({ ...formData, householdAction: "join" })
                  }
                  className={`household-btn ${
                    formData.householdAction === "join" ? "active-join" : ""
                  }`}
                >
                ...
                {formData.householdAction === "create" ? (
                  <div className="animate-fade-in">
                    <label
                      ...
                      style={{ color: "#34d399", marginBottom: "0.25rem" }}
                    >
                      Pantry Name
                    </label>
                    <input
                  ...
                  <div className="animate-fade-in">
                    <label
                      className="section-label"
                      style={{ color: "#60a5fa", marginBottom: "0.25rem" }}
                    >
                      Enter Join Code
                    </label>
                    <input
            ...
            <div className="section-group">
              ...
              <div className="form-grid-2" style={{ marginTop: "0.75rem" }}>
                ...
                <select
                  name="gender"
                  onChange={onChange}
                  className="input form-select no-icon"
                >
            ...
            <div className="section-group">
              ...
              <div className="health-card">
                <h3 className="health-title orange">
                  ...
                  {commonAllergens.map((allergen) => (
                    <button
                      ...
                      className={`allergy-tag ${
                        formData.allergies.includes(allergen) ? "selected" : ""
                      }`}
                    >
                      {allergen}
                    </button>
        ...
        {step === 2 && (
          <form
            ...
            className="otp-section animate-fade-in"
